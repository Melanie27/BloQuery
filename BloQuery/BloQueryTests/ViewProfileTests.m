...
@property (nonatomic, stronf) NSString *userDescription;
...
- (void)setUp {
    ...
    self.viewProfileVC = [[VIewProfileViewController alloc] init];
    theUser.userDescription = [[NSString alloc] init];
    theUser.username = [[NSString alloc] init];
}
